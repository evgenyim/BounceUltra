...
public class RoomCreate {
    ...
    public static ArrayList<Room> create() {
        ...
        Point start_point = new Point(200, 51);
        Room Room0 = new Room();
        ...
        Room0.addGate(0, (float) MainActivity.height  - 100,200, (float) MainActivity.height,0,1, 3);
        RoomList1.add(Room0);
        ...
        Room1.addGate(0, (float) MainActivity.height-100,200, (float) MainActivity.height,180,1   , 3);
